...
offense = pd.read_csv(f"{NIBRS}/NIBRS_OFFENSE.csv", usecols=['offense_id', 'offense_code'])
...
victim_offender = pd.read_csv(f"{NIBRS}/NIBRS_VICTIM_OFFENDER_REL.csv", usecols=['victim_id', 'offender_id', 'relationship_id'])
